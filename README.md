# Awesome Taro with stars

多端统一开发框架 Taro 优秀学习资源汇总 [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re)

## 官方资源

* [Taro 项目仓库](https://github.com/NervJS/taro) ⭐ 37,670 | 🐛 1,603 | 🌐 TypeScript | 📅 2026-09-08
...
* [封装 Taro.request（拦截器，url 配置等）](https://github.com/TigerHee/taro-request) ⭐ 249 | 🐛 4 | 🌐 JavaScript | 📅 2019-12-02
* [Taro 最佳实践](https://github.com/js-newbee/taro-best-practices) ⭐ 127 | 🐛 2 | 📅 2019-03-07
* [使用 axios 完美代替 Taro.request](https://github.com/SpringHgui/axios-taro-adapter) ⭐ 29 | 🐛 1 | 🌐 JavaScript | 📅 2023-01-26
...
* Taro 组件库示例 [taro-components-sample](https://github.com/NervJS/taro-components-sample) ⭐ 54 | 🐛 12 | 🌐 JavaScript | 📅 2023-03-04 （默认是 React，Vue 请切到 Vue 分支）
* [TodoMVC React 版](https://github.com/NervJS/TodoMVC/tree/react) ⭐ 46 | 🐛 8 | 🌐 JavaScript | 📅 2023-05-17 (小程序 / H5)
* [TodoMVC Vue 版](https://github.com/NervJS/TodoMVC/tree/vue) ⭐ 46 | 🐛 8 | 🌐 JavaScript | 📅 2023-05-17 (小程序 / H5)
* [抖音一键去水印小程序 (Vue版): Taro + 微信云开发](https://github.com/terryso/super9) ⭐ 28 | 🐛 1 | 🌐 CSS | 📅 2021-02-21
* [彗星密码本 (React版): Taro + 微信云开发](https://github.com/MuxinFeng/taro-savePassword) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2021-08-18
...
* [书店小程序： Taro + Redux + 本地 Mock Server 示例项目](https://github.com/imageslr/taro-library) ⭐ 371 | 🐛 1 | 🌐 JavaScript | 📅 2022-02-13
* [知识付费小程序（TypeScript）](https://github.com/SmallRuralDog/yundocs) ⭐ 151 | 🐛 3 | 🌐 TypeScript | 📅 2019-01-22
* [Taro 整合 Dva 示例](https://github.com/zuoge85/taro-dva) ⭐ 149 | 🐛 9 | 🌐 JavaScript | 📅 2019-02-23
* [Taro 示例项目(内置 计数器 与 异步请求): Taro + Dva + Typescript + Immutable](https://github.com/didilinkin/elf-taro-cli/tree/taro-1.2.8) ⭐ 69 | 🐛 0 | 🌐 TypeScript | 📅 2023-03-27
* Taro 实验性特性项目 [taro-todo](https://github.com/NervJS/taro-todo) ⭐ 56 | 🐛 5 | 🌐 JavaScript | 📅 2019-04-04
* [taro 结合 zoro 完整方案示例](https://github.com/FaureWu/ztaro) ⭐ 39 | 🐛 22 | 🌐 JavaScript | 📅 2023-01-26
* [Taro+dva+wxParse 多端富文本解析示例](https://github.com/zcSkr/taro-dva-wxParse) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-13
* [Taro+Taro-UI+es6 入门 demo](https://github.com/hyyqcweb/taro-gank) ⭐ 12 | 🐛 0 | 🌐 JavaScript | 📅 2019-01-08
* Taro 端能力示例 [taro-apis-sample](https://github.com/NervJS/taro-apis-sample) ⭐ 11 | 🐛 2 | 🌐 JavaScript | 📅 2019-03-04
* [Taro-UI + Rematch 示例](https://github.com/qwIvan/taro-demo-todolist) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2018-11-26

## 开源项目

### Taro3.2

* [taro-rn-demo](https://github.com/wyzwhp/taro-rn-demo) ⭐ 29 | 🐛 1 | 🌐 TypeScript | 📅 2021-01-14
* [Taroify UI](https://taroify.gitee.io/taroify.com/introduce/)

### Taro3

* [基于 Taro + Taro-ui + Typescript + redux 开发的网易云音乐小程序](https://github.com/lsqy/taro-music/tree/feature_upgrade_taro3.0) ⭐ 2,008 | 🐛 3 | 🌐 TypeScript | 📅 2024-06-13
...
* [Taro + Taro-UI GitHub 小程序客户端 Gitter 源码](https://github.com/huangjianke/Gitter) ⭐ 3,679 | 🐛 23 | 🌐 JavaScript | 📅 2021-08-10
* 💯 [首个 Taro 多端统一实例 - 网易严选（小程序 + H5 + React Native）](https://github.com/js-newbee/taro-yanxuan) ⭐ 2,657 | 🐛 44 | 🌐 JavaScript | 📅 2022-12-10
* 💯 [基于 Taro + Dva 构建的时装衣橱(电商实战项目)](https://github.com/EasyTuan/taro-msparis) ⭐ 1,353 | 🐛 46 | 🌐 JavaScript | 📅 2022-12-09
...
* [基于 taro + dva 开发的音乐播放器小程序](https://github.com/huangzhuangjia/taro-music) ⭐ 167 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-09
...
* [Mounted - 一款基于 Taro 的小程序组件库](https://github.com/fjc0k/mounted) ⭐ 67 | 🐛 5 | 🌐 TypeScript | 📅 2020-06-06（Taro 1.x）
* [taro-visualization Taro 可视化库（charts、3d、Lottie等）](https://github.com/wuba/taro-visualization) ⭐ 45 | 🐛 3 | 🌐 TypeScript | 📅 2024-06-12（Taro 3.x）
* [taro-bdmark - 基于 Taro 的百度小程序 md 解析器](https://github.com/guozimo/taro-bdMark) ⭐ 14 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-28（Taro 1.x）
* [taro-svga Taro 使用svga动画库（资源体积更小、更高效、跨平台），支持weapp、h5 、tt、rn](https://github.com/wukongyang/taro-svga) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2023-12-13（Taro 3.x）
